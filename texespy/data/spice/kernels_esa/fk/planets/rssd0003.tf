...
========================================================================
   ...
   Version 3.0  -- December 16, 2021 -- Alfredo Escalante Lopez, ESAC/ESA

     Implemented Geocentric Solar Magnetospheric (GSM) CK based
     reference frame and dedicated SCLK definition.
...
========================================================================
   ...
   Generic Dynamic Frames names/IDs:
      ...
      GSM            1504399    EARTH    Geocentric Solar Magnetospheric
      ------------------------------------------------------------------
...
-------------------------------------
   ...
   The Geocentric Solar Magnetospheric frame is defined as follows:
   ...
   this SPK file needs to be loaded in order to compute the GSM reference frame
   ...
   evaluation of this frame when referring to it, e.g. GSM using de421
   ephemerides.

   The definition of the Geocentric Solar Magnetospheric reference
   frame is as follows:

   \begindata

      FRAME_GSM                     = 1504399
      FRAME_1504399_NAME            = 'GSM'
      FRAME_1504399_CLASS           =  5
      FRAME_1504399_CLASS_ID        = 1504399
      FRAME_1504399_CENTER          = 399
      FRAME_1504399_RELATIVE        = 'J2000'
      FRAME_1504399_DEF_STYLE       = 'PARAMETERIZED'
      FRAME_1504399_FAMILY          = 'TWO-VECTOR'
      FRAME_1504399_PRI_AXIS        = 'X'
      FRAME_1504399_PRI_VECTOR_DEF  = 'OBSERVER_TARGET_POSITION'
      FRAME_1504399_PRI_OBSERVER    = 'EARTH'
      FRAME_1504399_PRI_TARGET      = 'SUN'
      FRAME_1504399_PRI_ABCORR      = 'NONE'
      FRAME_1504399_SEC_AXIS        = 'Z'
      FRAME_1504399_SEC_VECTOR_DEF  = 'OBSERVER_TARGET_POSITION'
      FRAME_1504399_SEC_OBSERVER    = 'EARTH'
      FRAME_1504399_SEC_TARGET      = 'EARTH_NORTH_POLE'
      FRAME_1504399_SEC_ABCORR      = 'NONE'
...
NAIF ID Codes to Name Mapping
------------------------------------------------------------------------------

   This section contains name to NAIF ID mappings. Once the contents of this
   file are loaded into the KERNEL POOL, these mappings become available
   within SPICE, making it possible to use names instead of ID code in the
   high level SPICE routine calls.
